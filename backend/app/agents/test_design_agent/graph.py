...
def build_test_design_graph(provider: LLMProvider, on_test_case_batch=None, max_scenarios: int = 40):
    ...
    graph.add_node(
        "detailed_test_cases",
        make_detailed_test_cases_node(provider, on_test_case_batch, max_scenarios),
    )
